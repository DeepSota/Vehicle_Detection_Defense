...
class GradCam():
    ...
    def __init__(self, model, conv_layer, device):
        ...
        # self.model.to(device)
        #
        # self.hook_handles.append(self.model.features.register_forward_hook(self._hook_a))
        #
        # self._relu = True
        # self._score_uesd = True
        # self.hook_handles.append(self.model.features.register_backward_hook(self._hook_g))
        #
